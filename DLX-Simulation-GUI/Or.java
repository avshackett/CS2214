...
class Or extends StateControl{
    protected mOr m;
    public Or(AnchorPane aP, int instr, TextField instrField, Button next, Polygon ALU, Rectangle... args){
        ...
        C = args[x++];
        DMX = args[x++];
        m = new mOr(dlx, "or r3,r5,r2");
        instrField.setText("or r3,r5,r2");
    }
    ...
    //or r3,r5,r2 00a21825
class mOr extends Math{
    mOr(DLXControlViewController dlx, String instruction){
    ...
    protected void step1b(){
        instr = Integer.toUnsignedLong(0x00a21825);
        IR = instr;
        update();
    }

...
class BNEZ extends StateControl{
    protected mBNEZ m;
    public BNEZ(AnchorPane aP, int instr, TextField instrField, Button next, Polygon ALU, Rectangle... args){
        ...
        C = args[x++];
        DMX = args[x++];
        m = new mBNEZ(dlx, "bnez r9, test5");
        instrField.setText("bnez r9, test5");
    }
    ...
    //bnez r9, test5 1520ffe4
class mBNEZ extends Math{
    mBNEZ(DLXControlViewController dlx, String instruction){
    ...
    protected void step1b(){
        instr = Integer.toUnsignedLong(0x1520ffe4);
        IR = instr;
        update();
    }

...
class SLL extends StateControl{
    protected mSLL m;
    public SLL(AnchorPane aP, int instr, TextField instrField, Button next, Polygon ALU, Rectangle... args){
        ...
        C = args[x++];
        DMX = args[x++];
        m = new mSLL(dlx, "slli r2,r9,7");
        instrField.setText("slli r2,r9,7");
    }
    ...
    //slli r2,r9,7 d9220007
class mSLL extends Math{
    mSLL(DLXControlViewController dlx, String instruction){
    ...
    protected void step1b(){
        instr = Integer.toUnsignedLong(0xd9220007);
        IR = instr;
        update();
    }

...
class Addi extends StateControl{
    protected mAddi m;
    public Addi(AnchorPane aP, int instr, TextField instrField, Button next, Polygon ALU, Rectangle... args){
        ...
        C = args[x++];
        DMX = args[x++];
        m = new mAddi(dlx, "addi r11,r13,-3");
        instrField.setText("addi r11,r13,-3");
    }
    ...
    //addi r11,r13,-3 21abfffd
class mAddi extends Math{
    mAddi(DLXControlViewController dlx, String instruction){
    ...
    protected void step1b(){
        instr = Integer.toUnsignedLong(0x21abfffd);
        IR = instr;
        update();
    }

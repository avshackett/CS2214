...
class LoadW extends StateControl{
    protected mLoadW m;
    public LoadW(AnchorPane aP, int instr, TextField instrField, Button next, Polygon ALU, Rectangle... args){
        ...
        MDR = args[x++];
        MDRMux = args[x++];
        m = new mLoadW(dlx, "lw r3,#2(r8)");
        instrField.setText("lw r3,#2(r8)");
    }
    ...
    //lw r3,#2(r8)  8d030002
class mLoadW extends Math{
    mLoadW(DLXControlViewController dlx, String instruction){
    ...
    protected void step1b(){
        instr = Integer.toUnsignedLong(0x8d030002);
        IR = instr;
        update();
    }

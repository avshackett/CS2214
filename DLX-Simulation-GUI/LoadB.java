...
class LoadB extends StateControl{
    protected mLoadB m;
    public LoadB(AnchorPane aP, int instr, TextField instrField, Button next, Polygon ALU, Rectangle... args){
        ...
        MDR = args[x++];
        MDRMux = args[x++];
        m = new mLoadB(dlx, "lb r2,#7(r5)");
        instrField.setText("lb r2,#7(r5)");
    }
    ...
    //lb r2,#7(r5)  80a20007
class mLoadB extends Math{
    mLoadB(DLXControlViewController dlx, String instruction){
    ...
    protected void step1b(){
        instr = Integer.toUnsignedLong(0x80a20007);
        IR = instr;
        update();
    }

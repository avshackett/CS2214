...
class Ori extends StateControl{
    protected mOri m;
    public Ori(AnchorPane aP, int instr, TextField instrField, Button next, Polygon ALU, Rectangle... args){
        ...
        C = args[x++];
        DMX = args[x++];
        m = new mOri(dlx, "ori r20,r11,1500");
        instrField.setText("ori r20,r11,1500");
    }
    ...
    //ori r20,r11,1500 357405dc
class mOri extends Math{
    mOri(DLXControlViewController dlx, String instruction){
    ...
    protected void step1b(){
        instr = Integer.toUnsignedLong(0x357405dc);
        IR = instr;
        update();
    }
    ...
    protected void step3(){
        ...
        postALU = A | imm;
        C = postALU;
        dlx.on(dlx.csAoe, dlx.csIRoeS2, dlx.csCload, dlx.csALUop, dlx.csS2op);
        update();
    }

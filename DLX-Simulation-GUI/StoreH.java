...
class StoreH extends StateControl{
    protected mStoreH m;
    public StoreH(AnchorPane aP, int instr, TextField instrField, Button next, Polygon ALU, Rectangle... args){
        ...
        MDR = args[x++];
        MDRMux = args[x++];
        m = new mStoreH(dlx, "sh #9(r3),r1");
        instrField.setText("sh #9(r3),r1");
    }
    ...
    //sh #9(r3),r1  a4610009
class mStoreH extends Math{
    mStoreH(DLXControlViewController dlx, String instruction){
    ...
    protected void step1b(){
        instr = Integer.toUnsignedLong(0xa4610009);
        IR = instr;
        update();
    }

...
class SRL extends StateControl{
    protected mSRL m;
    public SRL(AnchorPane aP, int instr, TextField instrField, Button next, Polygon ALU, Rectangle... args){
        ...
        C = args[x++];
        DMX = args[x++];
        m = new mSRL(dlx, "srli r3,r10,3");
        instrField.setText("srli r3,r10,3");
    }
    ...
    //srli r3,r10,3 dd430003
class mSRL extends Math{
    mSRL(DLXControlViewController dlx, String instruction){
    ...
    protected void step1b(){
        instr = Integer.toUnsignedLong(0xdd430003);
        IR = instr;
        update();
    }

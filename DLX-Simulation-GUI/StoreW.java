...
class StoreW extends StateControl{
    protected mStoreW m;
    public StoreW(AnchorPane aP, int instr, TextField instrField, Button next, Polygon ALU, Rectangle... args){
        ...
        MDR = args[x++];
        MDRMux = args[x++];
        m = new mStoreW(dlx, "sw -4(r7),r31");
        instrField.setText("sw -4(r7),r31");
    }
    ...
    //sw -4(r7),r31  acfffffc
class mStoreW extends Math{
    mStoreW(DLXControlViewController dlx, String instruction){
    ...
    protected void step1b(){
        instr = Integer.toUnsignedLong(0xacfffffc);
        IR = instr;
        update();
    }

...
class Subi extends StateControl{
    protected mSubi m;
    public Subi(AnchorPane aP, int instr, TextField instrField, Button next, Polygon ALU, Rectangle... args){
        ...
        C = args[x++];
        DMX = args[x++];
        m = new mSubi(dlx, "subi r12,r2,13");
        instrField.setText("subi r12,r2,13");
    }
    ...
    //subi r12,r2,13 284c000d
class mSubi extends Math{
    mSubi(DLXControlViewController dlx, String instruction){
    ...
    protected void step1b(){
        instr = Integer.toUnsignedLong(0x284c000d);
        IR = instr;
        update();
    }

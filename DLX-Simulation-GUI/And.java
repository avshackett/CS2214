...
class And extends StateControl{
    protected mAnd m;
    public And(AnchorPane aP, int instr, TextField instrField, Button next, Polygon ALU, Rectangle... args){
        ...
        C = args[x++];
        DMX = args[x++];
        m = new mAnd(dlx, "and r2,r1,r5");
        instrField.setText("and r2,r1,r5");
    }
    ...
    //and r2,r1,r5 00251024
class mAnd extends Math{
    mAnd(DLXControlViewController dlx, String instruction){
    ...
    protected void step1b(){
        instr = Integer.toUnsignedLong(0x00251024);
        IR = instr;
        update();
    }

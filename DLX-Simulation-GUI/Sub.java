...
class Sub extends StateControl{
    protected mSub m;
    public Sub(AnchorPane aP, int instr, TextField instrField, Button next, Polygon ALU, Rectangle... args){
        ...
        C = args[x++];
        DMX = args[x++];
        m = new mSub(dlx, "sub r5,r9,r12");
        instrField.setText("sub r5,r9,r12");
    }
    ...
    //sub r5,r9,r12 012c2822
class mSub extends Math{
    mSub(DLXControlViewController dlx, String instruction){
    ...
    protected void step1b(){
        instr = Integer.toUnsignedLong(0x012c2822);
        update();
    }
